                      ...
                      <div className="flex items-center justify-between mb-8">
                        <div>
                          ...
                          <p className="text-slate-500 mt-1 text-sm">
                            Trends extracted dynamically from your uploaded
                            documents
                          </p>
                        </div>
                      </div>
                ...
                <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
                  ...
                  <div className="divide-y divide-slate-100">
                    {documents.map((file) => (
                      <div
                        key={file._id}
                        className="p-4 md:p-6 flex items-center justify-between hover:bg-slate-50/80 transition-colors"
                      >
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm ${file.fileType.includes("image") ? "bg-purple-100 text-purple-600" : "bg-rose-100 text-rose-600"}`}
                          >
                    ...
                    {appointments.map((apt, idx) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 w-full md:w-auto mt-4 md:mt-0">
                          ...
                          <div
                            className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold border capitalize whitespace-nowrap ${getStatusColor(apt.status)}`}
                          >
                  ...
                  <div className="divide-y divide-slate-100">
                    {labBookings.map((booking, idx) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 w-full md:w-auto mt-4 md:mt-0">
                          <div
                            className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold border capitalize whitespace-nowrap ${getStatusColor(booking.status)}`}
                          >
